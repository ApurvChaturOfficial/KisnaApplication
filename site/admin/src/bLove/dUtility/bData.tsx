    ...
    content: {
      sections: [
        // Basic Information
        {
          ...
          inputs: [
            { name: "aImage", label: "Image", type: "file",
              onChange: (event: any, form: any, fieldName: string) => singleImageCreateHandleChangeUtility(event, form, "kisna_base", fieldName),
              onUpdate: (event: any, form: any, fieldName: string) => singleImageCreateHandleChangeUtility(event, form, "kisna_base", fieldName),
              onDelete: (event: any, form: any, fieldName: string) => singleImageCreateHandleChangeUtility(event, form, "kisna_base", fieldName),
            },
