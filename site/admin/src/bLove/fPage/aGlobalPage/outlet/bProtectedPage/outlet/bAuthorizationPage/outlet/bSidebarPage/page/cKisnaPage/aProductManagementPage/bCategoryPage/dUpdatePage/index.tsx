...
import CategoryUpdateComponent from "@/bLove/cComponent/aGlobalComponent/outlet/bProtectedComponent/outlet/bAuthorizationComponent/outlet/bSidebarComponent/children/cKisnaComponent/aProductManagementComponent/bCategoryComponent/dUpdateComponent";
...
const CategoryUpdatePage = () => {
  ...
  const APICall = {
    ...
    updateAPITrigger: categoryAPIEndpoint.useCategoryUpdateAPIMutation()[0],
    updateAPIResponse: categoryAPIEndpoint.useCategoryUpdateAPIMutation()[1],
