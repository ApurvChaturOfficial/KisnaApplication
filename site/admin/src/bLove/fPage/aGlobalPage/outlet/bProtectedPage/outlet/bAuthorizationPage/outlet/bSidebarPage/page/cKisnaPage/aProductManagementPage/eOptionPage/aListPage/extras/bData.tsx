...
const data = (APICall: any) => {
  return ({
    header: {
      ...
      buttons: [
        { label: "Create Option", to: fullRoute.aGlobalRoute.bProtectedRoute.bAuthorizationRoute.bSidebarRoute.cKisnaRoute.aProductManagementRoute.eOptionRoute.bCreateRoute }
      ]
    },
    content: {
