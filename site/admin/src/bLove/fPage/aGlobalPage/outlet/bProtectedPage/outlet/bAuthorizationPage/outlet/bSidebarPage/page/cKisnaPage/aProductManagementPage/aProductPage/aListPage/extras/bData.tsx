...
const data = (APICall: any) => {
  return ({
    header: {
      ...
      buttons: [
        { label: "Create Product", to: fullRoute.aGlobalRoute.bProtectedRoute.bAuthorizationRoute.bSidebarRoute.cKisnaRoute.aProductManagementRoute.aProductRoute.bCreateRoute }
      ]
    },
    content: {
