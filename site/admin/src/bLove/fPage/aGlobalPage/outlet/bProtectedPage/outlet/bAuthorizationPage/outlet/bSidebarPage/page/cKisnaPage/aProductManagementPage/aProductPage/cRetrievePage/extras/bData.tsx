            ...
            APICall.retrieveAPIResponse.isSuccess ? (
              APICall.retrieveAPIResponse.data.success ? ([
                ...
                // Relation Information
                {
                  ...
                  values: [
                    { label: "Category", value: APICall.retrieveAPIResponse.data.retrieve.cCategory?.aTitle, type: "normal" },
                    { label: "Tag", value: APICall.retrieveAPIResponse.data.retrieve.cTag?.map((each: any) => each.aTitle).join(", "), type: "normal" },
                    { label: "Options", value: APICall.retrieveAPIResponse.data.retrieve.dOption, type: "nested-list" },
                    { label: "Product Variant", value: APICall.retrieveAPIResponse.data.retrieve.cProductVariant?.map((each: any) => each.aTitle).join(", \n"), type: "textarea" },
                  ],  
                },
