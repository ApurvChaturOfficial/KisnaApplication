...
const data = (APICall: any) => {
  return ({
    header: {
      ...
      buttons: [
        { label: "Create Factor", to: fullRoute.aGlobalRoute.bProtectedRoute.bAuthorizationRoute.bSidebarRoute.cHappifyRoute.aQuestionnaireRoute.aQuestionRoute.bCreateRoute }
      ]
    },
    content: {
