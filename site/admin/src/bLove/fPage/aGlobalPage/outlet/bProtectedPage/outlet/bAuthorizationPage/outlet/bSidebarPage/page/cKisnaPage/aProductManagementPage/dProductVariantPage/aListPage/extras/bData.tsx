...
const data = (APICall: any) => {
  return ({
    header: {
      ...
      buttons: [
        { label: "Create Product Variant", to: fullRoute.aGlobalRoute.bProtectedRoute.bAuthorizationRoute.bSidebarRoute.cKisnaRoute.aProductManagementRoute.dProductVariantRoute.bCreateRoute }
      ]
    },
    content: {
