...
import { Table, TableBody, TableCaption, TableCell, TableFooter, TableHead, TableHeader, TableRow } from "@/aConnection/bShadcnConnection/components/ui/table"
...
const ProductVariantFormComponent = (props: any) => {
  ...
  // For Group
  const handleGroupSelection = (optionName: string) => {
