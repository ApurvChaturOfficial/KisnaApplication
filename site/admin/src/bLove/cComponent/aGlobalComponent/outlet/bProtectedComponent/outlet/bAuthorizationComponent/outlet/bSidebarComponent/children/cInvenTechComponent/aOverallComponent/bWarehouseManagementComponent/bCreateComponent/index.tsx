...
type WarehouseManagementCreateComponentType = {
  // ReduxCall: any
  // APICall: {
...
const WarehouseManagementCreateComponent = (_props: WarehouseManagementCreateComponentType) => {
  // // Destructure Props
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="flex justify-between" >
              <Button type="button" variant="destructive" asChild >
                <Link to={fullRoute.aGlobalRoute.bProtectedRoute.bAuthorizationRoute.bSidebarRoute.cInvenTechRoute.aOverallRoute.bWarehouseManagementRoute.aListRoute} >
                  Cancel
                </Link>
              </Button>
...
export default WarehouseManagementCreateComponent;
