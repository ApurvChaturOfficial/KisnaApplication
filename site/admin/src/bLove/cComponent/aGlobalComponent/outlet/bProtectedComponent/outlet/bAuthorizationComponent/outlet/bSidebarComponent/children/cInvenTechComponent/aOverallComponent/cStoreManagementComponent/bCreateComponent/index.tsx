...
type StoreManagementCreateComponentType = {
  // ReduxCall: any
  // APICall: {
...
const StoreManagementCreateComponent = (_props: StoreManagementCreateComponentType) => {
  // // Destructure Props
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="flex justify-between" >
              <Button type="button" variant="destructive" asChild >
                <Link to={fullRoute.aGlobalRoute.bProtectedRoute.bAuthorizationRoute.bSidebarRoute.cInvenTechRoute.aOverallRoute.cStoreManagementRoute.aListRoute} >
                  Cancel
                </Link>
              </Button>
...
export default StoreManagementCreateComponent;
