...
const apiResponseHandler = {
  createAPIResponseHandler: async (data: any, createAPITrigger: any, form: any, navigate: NavigateFunction) => {
    try {
      ...
      if (serverResponse.data && serverResponse.data?.success === true) {
        ...
        return navigate(fullRoute.aGlobalRoute.bProtectedRoute.bAuthorizationRoute.bSidebarRoute.cKisnaRoute.aProductManagementRoute.cTagRoute.aListRoute)
      }
