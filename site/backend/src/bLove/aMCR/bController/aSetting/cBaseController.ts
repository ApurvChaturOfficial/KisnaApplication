...
import { BaseModel } from "../../aModel/aSetting/cBaseModel";
  ...
  list: catchAsyncMiddleware(
    async (request: express.Request, response: express.Response, next: express.NextFunction) => {
      ...
      const list = await Model.find()
        ...
        .populate("cBaseOneToOne", "aTitle")
        .populate("cBaseOneToMany", "aTitle")
        .populate("cBaseManyToOne", "aTitle")
        .populate("cBaseManyToMany", "aTitle");
