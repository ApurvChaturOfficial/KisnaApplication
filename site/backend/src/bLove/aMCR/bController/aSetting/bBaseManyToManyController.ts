...
import { BaseManyToManyModel } from '../../aModel/aSetting/bBaseManyToManyModel';


const baseManyToManyController = (Model=BaseManyToManyModel, Label="BaseManyToMany") => ({
  // List
...
export default baseManyToManyController;
