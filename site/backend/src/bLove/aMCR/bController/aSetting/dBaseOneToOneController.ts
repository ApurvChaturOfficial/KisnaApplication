...
import { BaseOneToOneModel } from '../../aModel/aSetting/dBaseOneToOneModel';


const baseOneToOneController = (Model=BaseOneToOneModel, Label="BaseOneToOne") => ({
  // List
...
export default baseOneToOneController;
