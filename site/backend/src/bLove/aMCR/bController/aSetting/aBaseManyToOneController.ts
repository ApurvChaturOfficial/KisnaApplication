...
import { BaseManyToOneModel } from '../../aModel/aSetting/aBaseManyToOneModel';


const baseManyToOneController = (Model=BaseManyToOneModel, Label="BaseManyToOne") => ({
  // List
...
export default baseManyToOneController;
